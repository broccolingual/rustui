...
impl Style {
  ...
  pub fn to_ansi(&self) -> String {
    ...
    if self.attr.contains(Attr::NORMAL) { code.push("0".to_string()); }
    if self.attr.contains(Attr::BOLD) { code.push("1".to_string()); }
    if self.attr.contains(Attr::THIN) { code.push("2".to_string()); }
    if self.attr.contains(Attr::ITALIC) { code.push("3".to_string()); }
    if self.attr.contains(Attr::UNDERLINE) { code.push("4".to_string()); }
    if self.attr.contains(Attr::BLINK) { code.push("5".to_string()); }
    if self.attr.contains(Attr::FASTBLINK) { code.push("6".to_string()); }
    if self.attr.contains(Attr::INVERT) { code.push("7".to_string()); }
    if self.attr.contains(Attr::HIDDEN) { code.push("8".to_string()); }
    if self.attr.contains(Attr::REMOVE) { code.push("9".to_string()); }
